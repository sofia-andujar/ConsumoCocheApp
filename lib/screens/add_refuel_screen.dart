...
class AddRefuelScreen extends ConsumerStatefulWidget {
  ...
  @override
  AddRefuelScreenState createState() => AddRefuelScreenState();
}

class AddRefuelScreenState extends ConsumerState<AddRefuelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEditing ? 'Editar repostaje' : 'Añadir repostaje')),
      body: Padding(
